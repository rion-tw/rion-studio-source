...
- Ordinary role LocalStorage is persisted only by that role's isolated Chromium
  Session under its Rust-owned profile path. Rion Studio does not snapshot, forward, or
