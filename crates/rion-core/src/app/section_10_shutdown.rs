    ...
    async fn export_diagnostics(
        ...
        let diagnostics = json!({
            ...
            "logging": {
                ...
                "newestDebugTimestamp": logging.newest_debug_timestamp,
                "debugEntryCount": logging.debug_entry_count,
                "infoEntryCount": logging.info_entry_count,
                "warnEntryCount": logging.warn_entry_count,
                "errorEntryCount": logging.error_entry_count,
