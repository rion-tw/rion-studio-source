...
include!("behavior_02_v1_called_macro_timing_depends_on_each_definition_shortcut.rs");
include!(
    "behavior_03_v1_serializes_complete_key_and_click_sequences_across_same_role_invocations.rs"
);
include!("behavior_04_synchronous_looping_child_runs_once_before_the_parent_continues.rs");
include!("behavior_05_v1_parent_stop_keeps_an_unrelated_invocation_running.rs");
