...
- CI 34224123627 shared checks pass at exact
  ...
  full profile: clean report 2026-09-08T12-07-02-949Z-win32 runs
  12:07:03.036–12:23:51.913Z, 31 normal/three expected force, all 40 journeys,
  exact 34-phase membership/order and all phase exits zero. Artifact
  10055652342 SHA-256 is
  419ad18ef19f5f290cb83013290b743d4926588e984b0d25f78c41a18603f572;
  retained locally under ci-retained-state-stable with completePass=true
  reconciliation. Chromium report 2026-09-08T12-06-46-808Z-win32 runs
  12:06:47.022–12:25:18.348Z at the same exact SHA and passes 58 normal/four
  expected force, all 54 journeys and exact 62-phase membership/order. All
  phase exits are zero and all 58 normal final flush/process exits verify.
  worktreeDirty=true records ephemeral fixture preparation. Artifact
  10055704709 SHA-256 is
  0378c5f54ba22dc87b1f8ca5861822f627679984d635fd553abf918ac5eb4593,
  reconciled under ci-retained-state-chromium with completePass=true.
  Native job 102054376905 is SUCCESS: Windows Rust 1673 PASS/four ignored,
...
- Latest local complete chromium-windows-smoke report
  ...
  Mixed-recovery force/restore retain 399/426 Core observations without failed
  events. The pre-relaunch survivor window is
  a9dd8f12-4495-4945-8f7e-893e1e929f90, native parent 2, window generation 3,
  topology revision 16; Core/native tabs agree on
  f2f29d68-8672-4378-8511-28787102dc07 and
  d7599312-4b75-4494-8917-75618dcfa50e. These exact successful observations
  cannot recover missing primary/compensation causes from the historical failure.
...
- Exact 3c08e479117e47c2caa7ec0256efc1224202fe70 local full JS completes
  ...
  symlink EPERM, including the archive test whose expected unsafe-ancestor
  rejection is preempted by denied symlink creation. No timeout or document
  reference failure occurs in this run. This remains a local FAIL; no security
  assertion, test selection, deadline or OS privilege policy was weakened.
  Exact command/result/log are updater-job-local-full-js.* in the takeover
  evidence directory. The same source was pushed and dispatched once to
  Windows-only CI 34218883892 at 11:05:51.199Z after confirming no existing run
  for that source. No macOS or unchanged-source retry was dispatched.
  Local production Tauri build, Electron build and production E2E isolation
  also PASS at exact 3c08e479, with only ledger edits dirty. Logs/results are
  updater-job-production-tauri.*, updater-job-production-electron.* and
  updater-job-production-isolation.*. No native Rust implementation changed.
- Windows process/Job acknowledgement correction
  3c08e479117e47c2caa7ec0256efc1224202fe70 is a tooling/test change; App
  runtime remains 3eff9b2865f90b85908b1c71f605d64805051ddd. The updater
  cleanup now waits for the exact process exit after taskkill acceptance,
  retaining the existing 120-second external deadline and final absence check.
  Its native delayed-exit regression fails before the fix with the same
  "Updater target root process survived termination." error; native process
  observation and real OS exit execute while only taskkill acceptance is
  simulated. A rejected termination request remains failed. Probe and cleanup
  failures are now retained together, primary first, including thrown undefined.
  The failed 5cbcecfb run's missing earlier outcome cannot be reconstructed.
- CI 34214207165 is terminal FAIL at exact
  737d5a1f2a2ebc8cf7f7896c24a39faa3336514e, despite the complete native and
  full-profile passes. Its NSIS proof job fails because Job accounting retains
  one member after the root process handle signaled exit. Exact total remains
  three: root pwsh PID 6164, conhost PID 500 and installer PID 4732. The final
  active diagnostic identifies root PID 6164 (image query error 31); original
  observed image is C:\Program Files\PowerShell\7\pwsh.exe. The proof is not
  published; updater and packaged black-box are SKIPPED. Artifact 10052381939
  SHA-256 is e25be4db34d6690e20d4e068b12f9af8809771dd5c82d7f5a37389544a3e9be2.
- Local adjacent validation also reproduces accounting lag after a pinned
  conhost exit: root PID 12196, conhost PID 4276, cmd PID 23504, total three,
  root exit 0 and exact conhost wait complete but active count still one.
  The assertion remains failed in updater-job-adjacent.log (69 PASS/one FAIL).
  Correction 3c08e479 admits an accounting fence only for an already-signaled
  exact root with no other native Job member, or the existing exact sole
  conhost drain. The native ACTIVE_PROCESS_ZERO notification wakes a fresh
  authoritative Job-accounting query. The original remaining deadline,
  active-zero/count/cleanup gates and rejection of unknown/live members remain.
  Notifications and diagnostic image rows never establish PASS by themselves.
  Nonzero root exits are retained alongside a failed accounting fence.
  Native tests reject live roots, missing empty notifications and a different
  live member even after a prior empty notification. Final adjacent validation
  passes 70 tests/11 files; hygiene/typecheck/lint pass (23 existing warnings).
- UAC-free local stable full completes at documentation SHA
  d1e539059ea45b543e867fd1a04ad556825f5983, runtime/harness equivalent to
  737d5a1f at build/start: report 2026-09-08T10-37-02-204Z-win32,
  10:37:02.313Z through 10:49:58.464Z, 31 normal/three expected force,
  all 40 journeys, exact 34-phase membership/order and all phase exits 0.
  worktreeDirty=true initially reflects ledger edits; updater/Job tooling edits
  made later during the run do not relabel its already-built runtime. Force
  phases are p1-cross-domain-topology-force, force-terminate and crash-restart.
  Windows WebView2 is 152.0.0.0, Node 24.20.0 ARM64. This supersedes the local
  UAC-blocked partial stable runs, without erasing those failures.
- Diagnostic CI 34212812982 is terminal FAIL at exact
  5cbcecfb04a01a39dc6bf4c50a38b5178ead4801. Its native/full-profile passes
  remain valid, but updater cleanup fails before packaged black-box executes.
  At 10:38:22.518Z the retained original error is
  "Updater target root process survived termination." for PID 5192, following
  a successful taskkill return and an immediate process lookup. Job total is
  88/active-at-root-exit 0, with no observation error/truncation. This eventual
  Job drain is not success for the earlier failed cleanup. The old finally
  could overwrite an earlier probe error; that earlier outcome is unavailable.
  Black-box is SKIPPED, so the new black-box failure writer is not reached.
  Artifact 10051994123 SHA-256 is
  bf58d536c596ab27e2240d748c3d0c57926ddbbb5b960b25cfcc4e46987f774a.
  Actual NSIS installed payload still PASS: proof SHA-256
  237f71788adec60e379bf538b1cc224dc12b4ea3e174effaa03cf724f72934c5,
  unsigned 8.5.0 installer 101627246 bytes/SHA-256
  5fbcd4790b87d6b93043334b76fb5c95ca56f9da5f93605dca18fa390bc72460,
  normalized manifest f49abcdaffab1c7f2794b73ba08ab5ff66523716528173065057f357fc84e610,
  exact installed payload/no mutation/sole uninstaller and Job 3/active 0/
  exit 0/cleanup verified. No updater or black-box PASS is inferred.
- Correction-source Windows native job 102022219957 is SUCCESS at exact
  737d5a1f2a2ebc8cf7f7896c24a39faa3336514e: Rust 1673/4 ignored, native
  integration 16/eight files, full Windows JS 3864/48 platform skips (477 PASS/
  ten skipped files), lint and Tauri build. Its package job remains separate.
- The owner subsequently directs best-effort simulation/native-event coverage
  for unavailable dual-display hardware and actual OS sleep/sign-out. Do not
  require hardware purchases, display-mode changes or manual sleep/sign-out.
  Preserve the distinction between data simulation, exact native event ingress,
  and actual OS operations. Unavailable physical scenarios remain unverified
  observations rather than claims of physical PASS. Production fixture
  transactions still do not establish the four real production transactions.
- The requested local simulation audit passes 78 tests in 12 files at
  d1e539059ea45b543e867fd1a04ad556825f5983 (code 737d5a1f, only ledgers dirty),
  Node 24.20.0 ARM64, 10:36:49Z. Exact command and logs are retained in
  windows-takeover-4e5ec764/native-harness-hardware-simulation.result.json and
  .log. Coverage includes display topology revisions/listener isolation,
  negative coordinates and work-area bounds, stale display rejection, removed
  display fallback, explicit macOS/Windows power ordering and cleanup-failure
  races, disposal, exact session-end terminal replay, native-action drain,
  renderer quit acknowledgement and startup quit fences. The Tauri power
  contract and strict standby E2E ingress source assertions also pass. This
  review found no additional failing case; it does not claim synthetic data
  operates a physical monitor or causes an actual OS sleep/sign-out.
- Correction-source CI 34214207165 at exact
  737d5a1f2a2ebc8cf7f7896c24a39faa3336514e now completes both full profiles.
  Stable report 2026-09-08T10-14-07-874Z-win32 is clean and passes 31 normal/
  three expected force, all 40 journeys and exact 34-phase membership/order.
  Artifact 10051715847 SHA-256 is
  6a66ad42db570afb9b649e25131a1903715b17a58bf4898173d872bdf41e1eac.
  Chromium report 2026-09-08T10-13-51-870Z-win32 passes 58 normal/four expected
  force, all 54 journeys and exact 62-phase membership/order. Artifact
  10051789691 SHA-256 is
  30338bc718f68e81ab820e1af52dfd27aa4783aeff23e6a42943922f69456b45.
  All phase exit codes are zero and all 58 normal Chromium phases final-flush
  and process-exit; worktreeDirty=true is ephemeral fixture preparation.
  Shared JS passes 3893/23 platform skips (481 PASS/six skipped files).
  Native and package jobs continue; these profile results do not repair the
  independently recorded historical timeout/buffer failures.
- Diagnostic-source Windows native job 102017737381 is now SUCCESS at exact
  5cbcecfb04a01a39dc6bf4c50a38b5178ead4801: Rust 1673/4 ignored, native
  integration 16/eight files, Windows JS 3857/48 platform skips (475 PASS/
  ten skipped files), lint and the complete Tauri build pass. The 256-round
  updater winner test remains unchanged. At 10:31Z the previously observed
  UAC process PID 648 is absent; a matching local stable E2E rebuild starts
  at documentation head d1e539059ea45b543e867fd1a04ad556825f5983, whose code
  is unchanged from 737d5a1f. No new local UI PASS is inferred from its absence.
...
- CI 34209380675 is terminal FAIL at source/workflow head
  ...
  3852/48 platform skips (474 PASS/10 skipped files), including all four new
  native process-terminal tests. The updater 256-round winner test is intact.
  Stable full passes as recorded below; Chromium remains incomplete.
- Package job 102006478624 passes NSIS installed-payload proof SHA-256
  061198796a43fe169f73fa7853ffdb6fa5f1d19927f106aa73e8cb5d20b3c5cf.
  Unsigned 8.5.0 installer is 101629204 bytes/SHA-256
  a2d86165ddd59d62ab66cd868d7b76ae30dc16d1bb202b0681777f189a43c89d;
  installed executable remains SHA-256
  373ce09ca562a701155a8fd94ca1fe59e68403a71d28ab44fc3f19ddda8eca62.
  Source and normalized installed manifests match at
  ddc54a22a6cd9dfcec75c2458a877f88eb8df6dedb275e13487463ba1fd50e0e,
  only the expected uninstaller is added, and Job 3/active 0/exit 0 plus cleanup
  verify. The actual updater step then passes at 09:46:16.429Z: persisted
  observations bind Electron-v23 8.4.0 to 8.5.0, the same installer hash and
  updater manifest SHA-256
  1c60c3a1888b5b68887819fad947fc001cb1d68f0a107e1d33e7d8b2861b2943.
  Both packaged-artifact-manifest-fail-closed and
  windows-installed-layout-replacement-and-relaunch report applied. This runs
  the real Rust signature/hash/transaction path, verifies the installed version,
  fresh-process journal removal and preserved user-data marker before cleanup.
  Target installer PID 1796, old-uninstaller 3544 and installed application
  root 2452/descendants 7660, 6188, 8276 are observed; Job total 88/active 0,
  no observation error or truncation. These are ephemeral fixture observations,
  explicitly authoritative=false/productionTerminalReceipt=false. There is no
  Tauri-v22 source case and none of the four production transactions is claimed.
- Packaged black-box now executes but FAILS. Artifact directory
  2026-09-08T09-46-51-896Z-c29f0d80-dedb-47de-a615-113f7d7b3f7d-win32-packaged-black-box
  contains empty packaged-stdout.log and packaged-stderr.log, no passed report
  or screenshot. Packaged root 5984 and child PIDs 836/8472/3988 execute from
  win-unpacked; cleanup reaches Job total 25/active 0, command exit 1.
  The original harness error/failed substage is unavailable and is not inferred
  from process order. Final artifact 10050138648 is downloaded/hash verified:
  503c6bed86ff80887deebf503d184bfeedcca47cffb2d1f7df4a3390dd44f9a0.
- Diagnostic-only 5cbcecfb04a01a39dc6bf4c50a38b5178ead4801 adds a create-new
  packaged-smoke-failure.json on the existing failure path, with stage, exact
  child PID, package hashes and bounded/redacted original plus cleanup errors.
  It never writes a passing report, changes cleanup/deadlines or substitutes
  diagnostics for native authority. The already-tested updater error serializer
  is shared unchanged. The primary Error remains the same object when cleanup
  and persistence succeed; failures retain original-first aggregate order.
  Explicit darwin/win32 serialization, native-cleanup and adjacent release
  checks pass 64/2 existing platform skips in six files; hygiene/typecheck/lint
  pass (23 existing warnings). This is lower-layer-covered harness evidence,
  not a product behavior change. CI 34212812982 was dispatched once at
  09:57:05Z for this exact new source to recover the unavailable black-box
  failure; no same-source rerun or macOS run is dispatched.
  Local pnpm run build, build:electron and check:desktop-e2e-isolation pass at
  exact 5cbcecfb with only these ledger edits dirty. No App runtime or Rust
  authority implementation changed after 3eff9b28; the later Core edit is a
  shutdown-terminal assertion in the restart test.
- Stable job 102006478859 in CI 34209380675 completes SUCCESS at exact
  0c070d9126b7bedbf3c2a66f15cc8031c4d3a4c8. Report
  2026-09-08T09-21-05-931Z-win32 has clean checkout, 31 normal PASS/three
  expected force, all 40 journeys PASS, exact 34-phase membership/order and
  every phase exit code 0. The force phases are p1-cross-domain-topology-force,
  force-terminate and crash-restart. Downloaded artifact 10049778400 SHA-256:
  b52b9d1d5fdfdeacef908c7b6dd1a06d9a5313746246b27ab020d293b07e0b1d.
  This does not change the independent incomplete Chromium verdict below.
- In-progress CI 34209380675 at exact
  0c070d9126b7bedbf3c2a66f15cc8031c4d3a4c8 already has a failed Chromium
  report, 2026-09-08T09-21-26-718Z-win32: two phases PASS/one FAIL,
  one journey PASS/two FAIL/51 NOT_RUN, 59 of 62 phases unexecuted and no
  expected force reached. Artifact 10049370472 is downloaded/hash verified as
  017b4404b42ca2beaf819505a8f720ced699d379564b90771f0a3c91be77c8ae.
  chromium-shell-smoke fails at createFocusedApplicationShortcutRuntime's
  first native newGameWindow shortcut. The existing 30,000 ms helper boundary
  reports code=unknown/killed=true/signal=SIGTERM, with no stdout/stderr or
  shortcut-stage marker. No native chord submission or trusted pointer/input
  receipt is established; no Game Window was created. The helper PID and its
  pre-script startup state are unavailable. App PID 4548 still final-flushes
  and exits, as do the two normal phases. This is not the previous mixed-seed
  load error, and neither failure is erased. The independent package build
  proceeds; its result and new stable/native results remain pending here.
  Shared job 102006478850 passes 3888/16 platform skips, 480 PASS/4 skipped
  files. The four added native Windows cases are appropriately unavailable on
  this portable shared runner; Windows full-JS execution remains required.
...
- Windows-only CI 34198254073 is dispatched once for exact tooling source
  ...
  Shared checks pass 3876 JS tests/11 platform skips. Stable full passes
  31 normal phases + three expected force terminations/40 journeys; report
  2026-09-08T07-14-45-533Z-win32, artifact 10045318438, SHA-256
  c6fb6fe75f6b98675230658a330491a8ff34f9d3f4702275ab8faf65e04e5695.
  Complete chromium-windows-smoke passes 58 normal phases + four expected
  force terminations/54 journeys; report 2026-09-08T07-14-42-429Z-win32,
  artifact 10045417927, SHA-256
  6b0e29140afb4c7c7e5d9326f310eddbfdab085065e195d723e4a08aa1d22104.
  Downloaded ZIP hashes, exact source, all 34/62 phase memberships/order,
  journey aggregation and every phase exit code verify. All 58 normal Chromium
  phases have final flush and process exit. Its dirty-tree flag follows the
  workflow's ephemeral updater trust/version fixture preparation. These are
  complete profile results, not focused checks or normalized step conclusions.
  Windows native job 101970942425 is SUCCESS: Rust lint and 1673 PASS/4 ignored,
  native integration 16 PASS/eight files, complete Windows JS 3835 PASS/48
  ...
  scope is an API probe, not a Role/native-adapter receipt; Role/Macro behavior
  is separately established by the complete profile.
- The 0935ac59 full-profile import evidence retains role
  0012d54c-1108-49f7-b67c-f21eb8e24c50 and unchanged seed/restart source SHA-256
  4a084fd27afbee113ef5cb0727301a35ea72afd6058ac5e879fbb25df5daec09.
  Visible directory selection uses PID 1036/dialog HWND 4391366, Edit HWND
  4194876/control 1152 and Button HWND 393772/control 1; exact owner and dialog
  closure verify. Native session-end uses PID 3976/HWND 2621574, with exact
  WM_QUERYENDSESSION acknowledgement and prevention. Standby and fresh-process
  import journeys pass in the complete profile; actual OS sleep/sign-out and
  the missing physical second display remain unverified.
...
- CI 34187765250 is terminal FAIL at exact source
  ...
  3819 PASS/2 FAIL/48 skips; shared job 101939450061 reports 3861 PASS/2 FAIL/10
  skips. Both failures are the adjacent primary-navigation mock's missing
  browser export. Stable job 101939449983 fails smoke-seed's obsolete .app-page
  handle (artifact 10041303149), so its full profile is not green.
  E2E-only 129702a33e37ce8b1d80ff31e0e32b3ce72125c5 requeries every current-page
  condition and updates the adjacent mock. Explicit darwin/win32 fixtures retain
  wrong headings, hidden/missing primary actions, wrong empty/header states and
  forbidden kicker failures. The original 10 s deadline remains; 18 focused
  tests PASS, not a full-profile verdict. Affected journeys: DASHBOARD-NAV-001,
  CHROMIUM-MACOS-APPKIT-PRIMARY-NAV-008, CHROMIUM-WINDOWS-PRIMARY-NAV-008.
- Chromium job 101939449858 at caea487d completes all 62 phases: 58 PASS plus
  four expected force, 54 journey PASS, and all 58 normal phases have final
  flush, process exit and exit 0. Report 2026-09-08T04-41-10-400Z-win32,
  artifact 10041391334, SHA-256
  bd14a64e7a0e16e41e0c59141bbdde0a48f71c6b3f71602c13089d1391350cd6.
  The fixture explicitly stamps 8.5.0, so dirty=true is retained. Target build,
  previous 8.4.0 fixture, extension/runtime/package/distribution and native NSIS
  absent/running checks pass; installed proof fails at 05:04:59 UTC with four
  total processes instead of three and one active at root exit. Observed PIDs:
  pwsh 2360/7956, conhost 6192, installer 6576 at
  D:\a\_temp\rion-electron-installer-payload-771c6aa4fcbe4d8e9f5410abc2b65771\input\Rion.Studio-win.exe.
  These creation observations do not identify which process remained active.
  No valid proof is written; Rust updater and packaged black-box are skipped.
  Receipt: ci-caea-terminal-reconciliation.json under the takeover artifact root.
- Tooling-only c153c0c737fde081d6b5050e4bfe8d1fa6a507c5 records one bounded
  Job member snapshot after exact root exit and before cleanup. Native tests
  identify the exact held child before its release; adjacent tests total 28 PASS
  and two existing platform skips. Typecheck, hygiene and lint pass (23 existing
  lint warnings). E2E omission: lower-layer-covered. The authoritative active
  count, expected total 3, root exit and cleanup assertions are unchanged.
  CREATE_NO_WINDOW probes still create conhost (5 versus expected 3); attempted
  DETACHED_PROCESS launch does not preserve PowerShell exit semantics. Those
  failed implementations are withdrawn and retained only in
  rejected-headless-job-approaches.patch and their logs, not committed as fixes.
  A mis-forwarded pnpm '--' accidentally started a non-elevated full suite;
  it was cancelled after the known symlink EPERM failure and is not a verdict.
- Final production restoration is now complete: clean Tauri build at
  2ee06d88c1007fa0fb1335dba2ec67bbc7125bc4; clean Electron build, production
  isolation and runtime checks at 129702a33e37ce8b1d80ff31e0e32b3ce72125c5.
  Receipts restored-production-{tauri,electron,isolation,runtime}-final bind
  commands/times and Node 24.20.0 x64. App runtime source remains
  d4993ed8cf890e6c5468447aceca3acd6c373099; installer source remains
  9e56d430ee464f0c0ce4c511ea8badfd8661612d. Actual addon SHA-256 remains
  68e96299d9810f601800c257b1b2c025942ce924c27698b32dbf9e645c032c84;
  restored-final-addon-inventory.json finds no retired child-HWND exports and
  retains NativeAppCore. The UAC PID 648/HWND 12648580 is still present; local
  trusted UI remains pending dismissal, without bypassing Windows policy.
- Local runner c17f9763f28409c0582a8a7730809017b004ac63 starts clean. Stable
  report 2026-09-08T02-07-16-602Z-win32 has 31 PASS plus three expected force
  phases (p1-cross-domain-topology-force, force-terminate, crash-restart), all
  phase exit codes 0 and 40 journey PASS. The Tauri E2E binary was rebuilt at
  d67d87596695b912ff8912481dbf7356ae1e9778; WebView2 is 152.0.0.0. Stable
  reports do not expose Electron final-flush flags. Receipt: stable-full-after-claim-ready.
- Chromium report 2026-09-08T02-25-16-277Z-win32 has 58 PASS plus four expected
  force phases, 54 journey PASS, and every normal phase has electronFinalFlush,
  electronProcessExited and exit 0. The force phases are chromium-app-recovery-force,
  chromium-mixed-recovery-force, chromium-window-recovery-force and
  chromium-window-recovery-restore-force. Receipt: chromium-full-isolated.
  Electron E2E outputs were rebuilt at c17f9763; runtime source remains
  d4993ed8cf890e6c5468447aceca3acd6c373099. Later edits during the run only
  touch packaging tools, workflow and adjacent tests, not this running profile.
  No build, archive extraction or filesystem stress probe overlaps either
  isolated complete profile. Prior OS 5/ReplaceFileW failures are retained;
  later PASS neither identifies their cause nor proves them fixed.
- Full tabs pre-relaunch evidence retains survivor window
  f2a27272-00ba-4b5d-ae6e-6c5646e41e8c, HWND 7145078, generation 3, topology
  revision 24, native parent 2. Alpha 86748a7e-5a4c-433f-9fc7-94d48cdefc26
  and Beta c81c1a15-131d-4a16-b423-92282e4f1dff survive; Gamma
  6f253941-a3d9-4677-82e6-e304d93d7507 is persisted but closed before relaunch.
  The diagnostic is separate from strict normal-stage history; shellErrors is
  empty. Normal topology, pointer hit, detach and restart assertions all pass.
- Full import retains Role cf572faa-a3ff-4591-ac79-2ac6c2deb063 and source
  digest d7a5c93bfeb031edb971335139ea121e14e03ff897b456aa1c954b4636b0df73.
  Native chooser Edit HWND 22807932/control 1152 and Select HWND 9701014/control 1
  belong to PID 14968/dialog 8193720. Source bytes remain unchanged; imported
  cookie and LocalStorage markers survive a fresh process in the managed Role
  Chromium store. No user's Chrome profile becomes a live runtime.
- Local focused reports at c17f9763: standby 2026-09-08T02-00-18-529Z-win32,
  trusted input 2026-09-08T02-02-31-044Z-win32, mixed recovery
  2026-09-08T02-03-11-051Z-win32. These are followed by complete Chromium PASS.
  CHROMIUM-WINDOWS-MACRO-STANDBY-RECOVERY-023 uses the actual single Electron
  powerMonitor listener, epoch/disposal fences and held-input cleanup; events
  are synthetic, actual OS sleep is unverified. Full session-end target PID
  17188/HWND 8914604 has one listener, acknowledged/prevented WM_QUERYENDSESSION,
  normal flush/exit and actualOsSignOut=false; no direct controller call.
- CI 34178511175 checks out d67d87596695b912ff8912481dbf7356ae1e9778 although
  workflow metadata has documentation head c17f9763. Native job 101912729447
  passes Rust 1673/4 ignored, native integration 16 and JS 3813/48 skips.
  Stable artifact 10038386129/report 2026-09-08T02-01-07-258Z-win32 has 31+3/40;
  Chromium artifact 10038472885/report 2026-09-08T02-01-12-194Z-win32 has
  58+4/54 with all normal flush/exit. Chromium worktreeDirty=true is the explicit
  ephemeral 8.5.0 fixture version application. Artifact 10038505061 separately
  has 24 trusted direct-View input observations with preserved focus; this
  isolated API probe does not replace the full Role/native-adapter journeys.
- That run's package job 101912609746 builds Electron 43.6.0/Chromium
  150.0.7871.250/Node 24.20.0/Core 8.5.0 and previous-version fixtures, then
  fails loading Microsoft.PowerShell.Security in powershell.exe during package
  verification. Installed payload/update/packaged black-box are NOT_RUN.
  Local default and explicit-module probes both return NotSigned; the exact
  hosted module-loading cause is not reproduced. Tooling/CI commit
  ca4375cfa86a17c62cdb6140d28ba56ac2aa872e explicitly imports the executing
  host's Security manifest with terminating errors in all three Authenticode
  probes, preserves the unsigned assertion, retains NSIS proof after cleanup
  and logs bounded public updater observations without altering terminal schemas.
  Four focused files/44 tests, typecheck, full ESLint and hygiene pass. Complete
...
- Final production restoration at ca4375cf passes pnpm run build (clean start),
  ...
  Electron 43.6.0/Chromium 150.0.7871.250/Node 24.20.0/Node-API 10/Core 0.1.0.
  The rebuilt addon rejects every retired child-HWND export and exposes
  NativeAppCore; final-addon-inventory.json binds its exact bytes. Receipts:
  final-production-tauri, final-production-electron, final-production-isolation,
  final-production-runtime. Shared output directories now contain production
  assets, so any later E2E run must rebuild its appropriate shell first.
- CP-08 closes on post-deletion native integration/addon inventory, direct-View
  observations and complete local/CI trusted Role input, modifiers, middle button,
  zoom/reload, background/hidden delivery and Macro retirement journeys. CP-10
  closes on prior shared helper/paired lifecycle evidence plus complete visible
  consent/import/restart on macOS 85f662f4860c9af1623580510f35997256108b66 and
  Windows c17f9763. Source audit from 85f662f4 through d67d8759 changes only the
  launch coordinator/geometry in app runtime; these input/import boundaries and
  retained AppKit adapter are unchanged. This boundary-specific closure does
  not relabel the new coordinator as macOS-native validated or close migration.
...
API closure is 11/18 after the latest complete-profile reconciliation above.
Physical dual-display, production-key transactions, terminal promotion and the
final configuration delta remain independent gates. Actual OS sleep is an
unverified observation; the owner does not require manual sleep/wake assistance.
...
checks, native validation, stable full, complete Chromium E2E, fixture
package/updater and packaged AppKit black-box. The whole run is SUCCESS; no
Windows jobs were requested. This source includes the owner's
Website changes at **486e0842be6b14c132e9d4a33ece1c5a5fd16983** and the
**8d68be93** WDIO service-order correction.

The latest completely successful CI is **34164313951**, source **85f662f4**:
shared checks (3848 JavaScript PASS / nine platform skips), native validation
(1681 Rust PASS / five ignored; 14 Electron native PASS / two platform skips),
stable full (31 PASS + three expected force terminations / 40 journeys), hosted
Chromium (56 PASS + four expected force terminations / 52 journeys), fixture
package/updater and packaged AppKit black-box. All 60 Chromium phases prepare
the native sampler exactly once without the former setup error. Historical CI
34149031009 at b8bae38b and 34145679440 at 90614cef remain SUCCESS at their own
sources. The a8fab843 cleanup failure remains unexplained; current success does
not erase or retrospectively repair it.
...
| CP-10 consented import | Visible consent/import/restart PASS in 85f662f4 physical hardware profile and full Chromium CI | Native chooser and complete consent/import/restart acceptance pending |
...
| CP-15 complete profiles | 85f662f4 physical hardware 57 PASS + 4 expected force exits; 85f662f4 stable 31 + 3 and hosted Chromium 56 + 4 | Final-source full and hardware profiles pending |
| CP-16 package/updater | 85f662f4 fixture package/updater/black-box PASS; a8fab843 cleanup failure still under diagnosis | Final-source package/update acceptance pending; production-key cutover remains separate |
...
new correction; the complete hardware profile also passes. Complete macOS CI also passes. Full local JavaScript passes 475 files / 3857
...
and the power-event fence/ingress correction. Complete macOS CI 34164313951 now passes at the same 85f662f4 source. The latest complete
...
| CP-04 | P1 / Runtime projection | implemented; macOS 85f662f4 native/full hardware and Windows local 1ae51c6e / CI 68a0e92c complete profiles pass; d4993ed8 coordinator and 3eff9b28 native-control drain still need exact-candidate macOS native acceptance | CP-01 | Extract equivalent snapshot, bounds, visibility, zoom, reparent and compensation steps; retain AppKit transaction/geometry and Windows host effects. Test stale revision, partial application, compensation failure and exact quarantine, plus paired topology/recovery journeys. |
...
### 85f662f4 complete hosted Chromium evidence — 2026-09-08

CI **34164313951** completes the macOS Chromium E2E step successfully before
starting the release-artifact build. Artifact **10034074878**,
chromium-shell-e2e-macOS-34164313951-1, contains report
**2026-09-07T21-47-30-481Z-darwin/report.json**. It records exact source
85f662f4860c9af1623580510f35997256108b66, chromium-macos-appkit-smoke /
chromium-v23-macos-appkit, started 2026-09-07T21:47:30.804Z and finished
22:10:30.724Z: **56 PASS + four EXPECTED_FORCE_TERMINATION / 52 journey PASS**.
Every ordinary phase has final flush and process exit verified. worktreeDirty
is true after the workflow's ephemeral updater fixture/version preparation;
this is not represented as a pristine checkout or production-trust evidence.

The strengthened powerMonitor standby journey passes on this hosted Mac as well
as on the physical workstation. Its exact AppKit window is
6c78de0c-2165-40fe-b949-0ef7313ba293, launch generation
e5d04a97-8a4c-4be1-8ce9-6fb3d61cd0cf and native generation 1. Native evidence
records input epoch 1, cleanup/restart epoch 2 and terminal lifecycle epoch 3,
with the schema-v2 clean journal and normal process exit. This remains synthetic
power-event ingress with actual native input, not actual system sleep.

All 60 phase log sets contain exactly one native-sampler preparation marker;
none contains the former undefined-property setup error or preparation-unavailable
marker. The WDIO service-order repair remains effective on this new source.
The full CI artifact is retained under
`.desktop-e2e-artifacts/macos-takeover-8dff7722/ci-85f662f4-chromium`.

The package job continues into release artifact/previous-version fixture builds,
package verification, Rust-owned updater transactions and the packaged native
black-box. These downstream results are still pending and are not inferred from
full E2E success. The existing watcher remains live; no unchanged rerun is
requested. The separate migration execution ledger is now reconciled to this
workstation policy and keeps its five work packages / nine deliverables distinct
from the API ledger's nine remaining items.


### 85f662f4 complete package/updater acceptance and remaining gates — 2026-09-08

CI **34164313951** is now entirely **SUCCESS** at immutable source
**85f662f4860c9af1623580510f35997256108b66**. Package job **101872214608**
completes release artifacts, prior-version fixtures, extension persistence,
pinned runtime/package/distribution verification, the Rust-owned packaged updater
transaction and packaged native Role black-box. The log verifies Electron 43.6.0,
Chromium 150.0.7871.250, Node 24.20.0, Node-API 10 and Rust Core 8.5.0 on
darwin-arm64. At **2026-09-07T22:36:58.117630Z** it records:
"Verified darwin packaged updater transaction for 8.5.0."

The final packaged artifact **10034566802**,
packaged-chromium-role-black-box-macOS-34164313951-1, contains
**2026-09-07T22-37-00-222Z-c8a2245e-c065-47ad-9e83-2b761c1884b5-darwin-packaged-black-box/packaged-smoke-report.json**.
It reports passed, exitCode=0, application 8.5.0,
fixtureInteraction=visible-os-accessibility-click, hostKind=appkit-chromium and
remoteDebugging=false. The screenshot visibly retains the AppKit native tab and
window controls; its downloaded bytes match the receipt SHA-256.

| Exact package identity | SHA-256 |
| --- | --- |
| Executable | a201ff1c2a939a214589f28991f3020d59e85c1205ab1c442cfd27ee2568ebf0 |
| app.asar | 63092931623898ca39773c569a222b1fd3d8628dc1fab32136bb62ffae2538df |
| Native addon | d8566b2de818ac7d29c1d0a985957a5718aa1c769b7f0c06ea341a5d70ae59a6 |
| Package manifest | 94c90b027aa8488fa4460ada5b03cf2aea7f99d23ae11312441917e2c0d738f0 |
| Native screenshot | 8c336d03e2e48512e1340d703484993f5ce2b906c4d7c9db282072e150d26a26 |

The log and artifact are retained in
`.desktop-e2e-artifacts/macos-takeover-8dff7722/ci-85f662f4-package.log` and
`ci-85f662f4-packaged-blackbox`. No malformed process-group state or rejected
processGroupObservation recurs in this run. The a8fab843 failure remains
unexplained because its rejected ps row was unavailable; the existing bounded
diagnostic is retained. Neither later green runs nor the earlier bounded
unsuccessful reproduction prove a repair. No unchanged run is dispatched to
hunt for another outcome. The existing watcher exits zero and is closed.

This seals the currently executable macOS regression work at 85f662f4, including
clean physical hardware, hosted Chromium, stable full, native validation,
production builds/isolation, fixture update and packaged AppKit evidence.
These use the existing ephemeral updater fixture, not production-key cutover.
Root and remote remain synchronized; later documentation-only commits do not
create a new runtime candidate or justify rerunning CI.

| Remaining acceptance scope | Why the whole goal remains incomplete |
| --- | --- |
| Windows workstation, CP-04/08/10/11/12/15/16/18 | The seven ordered handoff workstreams above still need the owner's later Windows workstation: final-source full JS/native/full profiles, known recovery/detach failures, visible consented import, physical input/display/session-end and install/update. Mac and portable fixture results do not close them. No Windows CI is dispatched here. |
| Four real updater transactions, CP-16/17/18 | Published Tauri v22 and prior Electron must each transition to the exact target on both platforms under the real production lineage/trust/endpoint gates. Current CI fixture signing is not that evidence. |
| Promotion and final configuration delta | The terminal promotion receipt and final v22-configuration comparison remain separate execution gates. No publication, merge, credential change or inferred new infrastructure is authorized. The producer/finalizer/publication/recovery gates remain disabled. |
| Sole-entry retirement, CP-17/18 | Delete Tauri/System WebView-only runtime, dependencies and transition paths only after the preceding gates pass; retain AppKit and Rust data/topology/Macro authority. |
| Physical limitations and historical triage | Mixed-DPI is removed by owner decision. Actual sleep/wake is unobserved, with maximum automated behavior coverage and no manual-assistance prerequisite. The earlier a8fab843 cleanup diagnostic requires new exact failure evidence for further repair; current green acceptance does not supply it. |

API closure remains **9/18**. The migration ledger still has **five overlapping
work packages / nine deliverables**. No pending macOS CI watcher remains, and no
whole-goal completion or protected Tauri retirement is inferred from this Mac's
fully successful acceptance.
