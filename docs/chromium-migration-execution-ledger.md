...
| Chromium package/updater CI | The same run passes hosted Chromium E2E with 56 PASS + four expected force terminations / 52 journeys (artifact 10034074878). Job 101872214608 continues into package/updater verification. Historical fixture package/updater success at b8bae38b is not a result for the newer runtime correction or a production-key transaction. |
