...
Contract version 16 defines the shared semantics for WKWebView on macOS and
...
within version 16 only when the generated Rust/TypeScript contracts and all
