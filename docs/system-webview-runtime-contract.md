...
Contract version 18 defines the shared semantics for WKWebView on macOS and
...
within version 18 only when the generated Rust/TypeScript contracts and all
