...
Contract version 21 defines the shared semantics for WKWebView on macOS and
...
within version 21 only when the generated Rust/TypeScript contracts and all
