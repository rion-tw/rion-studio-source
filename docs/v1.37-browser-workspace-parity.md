...
- Current classifications: **1** direct tests, **190** assertion-evidenced replacements, **35** intentional System WebView-only changes.
...
- **35** behaviors depend on Electron, External Chrome, custom proxy, or superseded runtime policy that the System WebView-only architecture intentionally removed.
