/* global KeyboardEvent, addEventListener, location */
...
const channel = argument("rion-appkit-probe-channel");
const roleId = argument("rion-appkit-probe-role");
const surfaceGeneration = Number(argument("rion-appkit-probe-generation"));
const frameToken = argument("rion-appkit-probe-frame-token");
...
if (
  ...
  throw new Error("The private AppKit input-probe identity is invalid.");
}
