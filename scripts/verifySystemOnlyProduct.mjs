...
const removedPaths = [
  ...
  "scripts/runMacWebKitExperiment.mjs",
  "scripts/runMacWebKitExperiment.d.mts",
  "scripts/runMacDevBundle.mjs",
  "scripts/runMacDevBundle.d.mts",
  "scripts/macDevBundleInfoPlist.mjs",
  "scripts/macDevBundleInfoPlist.d.mts",
