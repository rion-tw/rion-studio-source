pub fn run() {
    ...
    let builder = builder.invoke_handler(tauri::generate_handler![
            ...
            desktop_e2e::desktop_e2e_application_lifecycle_signal,
            desktop_e2e::desktop_e2e_arm_automation_readiness_failure,
            desktop_e2e::desktop_e2e_suspend_automation_surface,
            ...
            desktop_e2e::desktop_e2e_mouse_input,
