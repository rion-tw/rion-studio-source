...
fn capture_presentation_batch_events(
    ...
    let context = json!({
        ...
        "noOp": outcome.no_op,
        "plannedSurfaceMutationCount": outcome.planned_surface_mutation_count,
        ...
        "receiptAppliedSurfaceMutationCount": receipt.applied_surface_mutation_count,
        "receiptPlannedSurfaceMutationCount": receipt.planned_surface_mutation_count,
        "receiptSkippedSurfaceMutationCount": receipt.skipped_surface_mutation_count,
        "receiptStatus": receipt.status.as_str(),
        "receiptSupersedeReason": receipt.supersede_reason,
        "receiptSurfaceCount": receipt.surface_identities.len(),
        "showMs": outcome.show_ms,
        "shownSurfaceCount": outcome.shown_surface_count,
        "skippedSurfaceCount": outcome.skipped_surface_count,
