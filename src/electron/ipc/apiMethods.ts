...
export const RION_API_INVOKE_METHODS = {
  ...
  getGraphicsSettings: true,
  updateGraphicsSettings: true,
  getGraphicsStatus: true,
  copyGraphicsReport: true,
...
export const RION_API_EVENT_METHODS = {
  ...
  onGraphicsSettingsChanged: true,
  onGraphicsStatusChanged: true,
