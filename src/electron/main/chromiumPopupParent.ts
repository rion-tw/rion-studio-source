...
/** Compares Electron frame wrappers by their stable native frame identity. */
export function exactChromiumPopupOpenerFrameEqual(
  ...
  const hasNativeRouting = leftFrame.processId !== undefined ||
    rightFrame.processId !== undefined || leftFrame.routingId !== undefined ||
    rightFrame.routingId !== undefined;
  return !hasNativeRouting || (
