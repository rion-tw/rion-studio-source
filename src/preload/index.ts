...
const api: RionStudioApi = {
  ...
  pickWorkspaceCompanionApplication: () => ipcRenderer.invoke(IPC_CHANNELS.workspacesCompanionPickApplication),
  openWorkspaceCompanion: (id) => ipcRenderer.invoke(IPC_CHANNELS.workspacesCompanionOpen, id),
