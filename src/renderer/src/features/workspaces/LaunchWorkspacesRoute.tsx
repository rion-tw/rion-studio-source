...
function WorkspaceLayoutPreviewSlot({
  ...
  return (
    <div
      ...
      data-workspace-preview-web-url={web?.lastUrl ?? ""}
      style={style}
    >
      {role ? (
        <img
          ...
          {role ? (
            ...
            <span className="workspace-role-chip-text">
              <span className="flex min-w-0 items-center gap-1.5 truncate">
                ...
                {t("workspaces.rionPortal")}
              </span>
              <span className="workspace-role-game-label min-w-0 truncate">{workspaceWebLastLocation(web, t)}</span>
            </span>
          ) : (
