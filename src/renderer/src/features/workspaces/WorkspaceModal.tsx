...
function WorkspaceSlotDropZone({
  ...
  return (
    ...
    >
      <button
        className={cn(
          "group/slot absolute isolate flex min-h-0 flex-col justify-between overflow-hidden rounded-t-lg border bg-cover bg-center p-3 text-left transition-[background-color,border-color,box-shadow,transform] duration-150 [--workspace-slot-caption-bottom-left-radius:0px] [--workspace-slot-caption-bottom-right-radius:0px] [--workspace-slot-radius:0.5rem] [contain:paint]",
          role
