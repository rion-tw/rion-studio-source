...
const knownErrorMessages: Partial<Record<string, TranslationKey>> = {
  ...
  "A role cannot synchronize localStorage from itself.": "error.roleLocalStorageSourceSelf",
  "The localStorage source role was not found.": "error.roleLocalStorageSourceNotFound",
  "A dependent role cannot be used as a localStorage source.": "error.roleLocalStorageSourceChain",
  "The localStorage source role must belong to the same game.": "error.roleLocalStorageSourceGameMismatch",
  "The localStorage source role must use the same launch origin.": "error.roleLocalStorageSourceOriginMismatch",
  "A source role with dependents cannot depend on another role.": "error.roleLocalStorageSourceHasDependents",
  "The game has no managed localStorage keys.": "error.roleLocalStorageKeysRequired",
