...
const knownErrorMessages: Partial<Record<string, TranslationKey>> = {
  ...
  "Launch workspace companion area is invalid.": "error.workspaceCompanionInvalid",
  "Launch workspace companion placement is invalid.": "error.workspaceCompanionPlacementInvalid",
  "Launch workspace companion size is invalid.": "error.workspaceCompanionSizeInvalid",
  "Launch workspace companion auto-open setting is invalid.": "error.workspaceCompanionAutoOpenInvalid",
  "Launch workspace companion shortcut is invalid.": "error.workspaceCompanionTargetInvalid",
  "Launch workspace companion URL must use HTTP or HTTPS.": "error.workspaceCompanionUrlInvalid",
  "Launch workspace companion application is invalid.": "error.workspaceCompanionApplicationInvalid",
  "Workspace companion shortcuts are not available.": "error.workspaceCompanionUnavailable",
  "Workspace companion shortcut is not configured.": "error.workspaceCompanionNotConfigured",
  "This companion application is not available on this operating system.": "error.workspaceCompanionPlatformMismatch",
  "Workspace companion application could not be found.": "error.workspaceCompanionMissing",
  "Unable to open workspace companion shortcut.": "error.workspaceCompanionOpenFailed",
