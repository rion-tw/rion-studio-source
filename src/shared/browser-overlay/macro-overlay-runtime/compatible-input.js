    ...
    try {
      if (command.action === "key") {
        ...
        const event = new window.KeyboardEvent(key.type === "keyUp" ? "keyup" : "keydown", {
          code: key.code, key: key.key, location: key.location, repeat: key.autoRepeat,
          altKey: (key.modifiers & 1) !== 0, ctrlKey: (key.modifiers & 2) !== 0,
          metaKey: (key.modifiers & 4) !== 0, shiftKey: (key.modifiers & 8) !== 0,
