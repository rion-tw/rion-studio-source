...
export type BrowserWorkspaceStatusRecord = { workspaceId: string, state: "launching" | "running" | "stopping", resolvedEngine?: ResolvedBrowserEngine, hostKind?: BrowserHostKind, issueReason?: SystemWebViewIssueReason, capabilitySnapshot?: EngineCapabilitySnapshotRecord, };
