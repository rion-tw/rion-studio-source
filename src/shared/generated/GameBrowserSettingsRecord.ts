...
export type GameBrowserSettingsRecord = { fonts: BrowserFontSettingsRecord, macroBadgePosition: MacroBadgePositionRecord, macroOverlay: MacroOverlaySettingsRecord, workspace: WorkspaceAppearanceSettingsRecord, };
