 ...
 */
export type GameCreateRequest = { name: string, iconImageDataUrl?: string | null, coverImageDataUrl?: string | null, defaultLaunchUrl: string, localStorageSyncKeys: Array<string>, };
