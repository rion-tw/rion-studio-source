 ...
 */
export type RuntimeWindowStopRequestRecord = { parentOperationId: string, windowId: string, windowGeneration: number, topologyRevision: number, tabIds: Array<string>, intentOrigin: string, };
