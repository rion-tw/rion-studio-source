export const IPC_CHANNELS = {
  ...
  rolesSessionMigrationPreview: "roles:session-migration:preview",
  rolesSessionMigrationApply: "roles:session-migration:apply",
  rolesSessionMigrationRollback: "roles:session-migration:rollback",
