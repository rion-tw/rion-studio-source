...
describe("desktop E2E manifest resolution", () => {
  ...
  it("inherits every lower profile phase, spec, and automated journey", async () => {
    ...
    ) as DesktopE2eManifest;
    {
      ...
      expect(journeysForDesktopE2eProfile(repositoryManifest, "chromium-macos-appkit-hardware-extended")).toHaveLength(61);
    }
    {
      ...
      expect(journeysForDesktopE2eProfile(repositoryManifest, "chromium-windows-hardware-extended")).toHaveLength(63);
    }
