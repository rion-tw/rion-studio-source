...
const TAB_ID = "44444444-4444-4444-8444-444444444441";
const ATTEMPT_ID = "55555555-5555-4555-8555-555555555551";
const OPERATION_ID = "66666666-6666-4666-8666-666666666661";
const WORKSPACE_TAB_ID = "44444444-4444-4444-8444-444444444442";
const WORKSPACE_ATTEMPT_ID = "55555555-5555-4555-8555-555555555552";
const WORKSPACE_OPERATION_ID = "66666666-6666-4666-8666-666666666662";
const WEB_SLOT_ID = "workspace-web-slot";
const WEB_SURFACE_ID = `web-${WORKSPACE_TAB_ID}-1`;
const RECT = { x: 0, y: 0, width: 1, height: 1 };
const MANAGED_RECT = { x: 0, y: 0, width: 0.5, height: 1 };
const WEB_RECT = { x: 0.5, y: 0, width: 0.5, height: 1 };
...
function dualDisplayTopology(): DisplayTopologySnapshotRecord {
  return projectElectronDisplayTopology({
    displays: [
      {
        id: 41,
...
function emptyCoreSnapshot(): CoreAppSnapshotRecord {
  return {
    revision: 1,
    stateRevision: 1,
    runtimeRevision: 0,
