...
describe("bulk selection UI", () => {
  ...
  it("keeps macro rows selectable without rendering a checkbox column", async () => {
    ...
    expect(nameLayout?.className).toContain("pl-7");
    ...
    expect(startButton.className).toContain("h-6");
    expect(startButton.className).toContain("w-6");
    expect(runLayout?.querySelector("svg")?.getAttribute("width")).toBe("12");
    ...
    expect(actionsButton.className).toContain("h-6");
    expect(actionsButton.className).toContain("w-6");
    expect(actionsButton.querySelector("svg")?.getAttribute("width")).toBe("12");
