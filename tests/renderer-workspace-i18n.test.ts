...
const workspaceHelpKeys = [
  ...
  "workspaces.webCategory.media",
  "workspaces.webCategory.live",
  "workspaces.webCategory.social",
  "workspaces.webCategory.other",
  "workspaces.webSite.iqiyi",
  "workspaces.webSite.youku",
  "workspaces.webSite.mango",
  "workspaces.webSite.bahamut",
  "workspaces.webSite.friday",
  "workspaces.rionPortal",
  "workspaces.webAtEntrance",
